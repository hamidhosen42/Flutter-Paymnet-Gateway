...
class BikashPayment extends StatefulWidget {
  final String title;

  const BikashPayment({Key? key, required this.title}) : super(key: key);

  @override
  BikashPaymentState createState() => BikashPaymentState();
}

class BikashPaymentState extends State<BikashPayment> {
